// Glow Composite Scoring — implements the client's weighted 5-pillar
...
// composite is shown but it is filtered out of the Glow basket.
...
// Gradient + accent palette used by the Glow Basket drill / hero cards.
...
export function decisionFor(rating) {
  switch (rating) {
    case "STRONG BUY": return {
      verdict: "Include in Glow Basket",
    ...
    case "AVOID": return {
      verdict: "Exclude from Glow Basket",
...
//   weights  - optional override of PILLAR_WEIGHTS (lets the Glow basket
