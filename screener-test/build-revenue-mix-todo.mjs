...
//   1. Glow STRONG BUY companies with no extraction yet
//   2. Glow BUY companies with no extraction yet
...
//
// Composite scoring is run inline so priority reflects the live Glow
...
const header = [
  ...
  `# Priority breakdown:`,
  `#   1 — Glow STRONG BUY (NEW): ${counts[1]}`,
  `#   2 — Glow BUY (NEW):        ${counts[2]}`,
